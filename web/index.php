					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="assets/index.html">Home</a></li> 
								<li class="nav-item"><a class="nav-link" href="assets/about-us.html">About</a></li> 
								<li class="nav-item submenu dropdown">
									<a href="assets/#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages</a>
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="assets/projects.html">Project</a></li>
										<li class="nav-item"><a class="nav-link" href="assets/project-details.html">Project Details</a></li>
										<li class="nav-item"><a class="nav-link" href="assets/elements.html">Elements</a></li>
									</ul>
								</li> 
								<li class="nav-item submenu dropdown">
									<a href="assets/#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Blog</a>
									<ul class="dropdown-menu">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="home_right_box">
								<div class="home_item">
									<a href="assets/#"  ><i title="Sofa" class="flaticon-sofa"></i></a>
								</div>
								<div class="home_item">
        		...
        		<div class="furniture_inner row">
        			<div class="col-lg-4">
        				<div class="furniture_item">
        					<img class="img-fluid" src="assets/img/furniture/furniture-1.jpg" alt="">
        			...
        			<div class="col-lg-4">
        				<div class="furniture_item">
        					<img class="img-fluid" src="assets/img/furniture/furniture-2.jpg" alt="">
        					<h4>Green Butter Sofa</h4>
        					<p>Sony laptops are among the most well known laptops on today’s market. Sony is a name that.</p>
        				</div>
        			</div>
        			<div class="col-lg-4">
        				<div class="furniture_item">
        					<img class="img-fluid" src="assets/img/furniture/furniture-3.jpg" alt="">
        					<h4>Green Butter Sofa</h4>
        					<p>Sony laptops are among the most well known laptops on today’s market. Sony is a name that.</p>
        				</div>
        			</div>
        ...
        <section class="projects_area">
        	<div class="row m0">
        		<div class="projects_item wd_18">
					<img src="assets/img/projects/projects-1.jpg" alt="">
					<div class="hover">
				...
				<div class="projects_item wd_18">
					<img src="assets/img/projects/projects-2.jpg" alt="">
					<div class="hover">
						<h4>Alex Complex for esidence</h4>
						<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create  slimmer.</p>
					</div>
				...
				<div class="projects_item wd_44">
					<img src="assets/img/projects/projects-3.jpg" alt="">
					<div class="hover">
						<h4>Alex Complex for esidence</h4>
						<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create  slimmer.</p>
					</div>
				...
				<div class="projects_item wd_18">
					<img src="assets/img/projects/projects-4.jpg" alt="">
					<div class="hover">
						<h4>Alex Complex for esidence</h4>
						<p>LCD screens are uniquely modern in style, and the liquid crystals that make them work have allowed humanity to create  slimmer.</p>
					</div>
        ...
        <section class="impress_area p_120">
        	<div class="container">
        		<div class="impress_inner text-center">
					...
					<a class="main_btn" href="assets/#">Read Details</a>
        		</div>
        	</div>
        </section>
        <!--================End Impress Area =================-->
